...
centers
  ...
  val fig = Figure()
  val p = fig.subplot(0)
  var points= new Array[Int](high-low+1)
  ...
  //val cost_points = new DenseVector(Array(5.13,6.00,6.47,7.29,11.82,15.42,19.05,35.24,54.8))
  //val cluster_points = new DenseVector(Array(10,9,8,7,6,5,4,3,2))
 // BT5 Elbow method visualization
  val cost_points = new DenseVector(cost)
  val cluster_points = new DenseVector(points)
